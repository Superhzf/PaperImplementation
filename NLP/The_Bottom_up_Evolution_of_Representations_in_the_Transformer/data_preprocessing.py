...
a while (no exact round is released). I choose NO_BETTER_THAN_ROUND=10 here. The
author just says 'stop training if the performance does not improve for a while'
"""
SAVE_MODEL_PATH='./data/TrainedModel/'
NO_BETTER_THAN_ROUND_FULL=10
